...
while nLayer <= nLayerFinest:
    ...
    if nLayer > nLayerTop:
        ...
        # Unpack nu_basic to sparse representation
    ...
    if params["hybrid_mode"]:
        ...
        evaluationData["time_flow"] += time.time() - t0
    ...
    for nEps, (eps, nIterationsMax) in enumerate(params["eps_list"][nLayer]):
        ...
        for nIterations in range(nIterationsMax):
            ...
            if params["hybrid_mode"]:
                # Compute flow # TODO: implement it in original nu_basics
                # Unpack marginals to sparse representation
                #t0 = time.time()
                ...
                muYAtomicIndicesList, muYAtomicDataList = \
                    DomDecGPU.unpack_cell_marginals_2D_box(
                        ...
                        bottom.ravel().cpu().numpy(), shapeYL
                    )
                ...
                evaluationData["time_flow"] += time_flow
